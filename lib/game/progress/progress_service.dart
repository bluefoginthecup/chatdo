  ...
  ProgressDelta _deltaFor(RewardEvent ev) {
    switch (ev) {
      case RewardEvent.scheduleCreated:
        return ProgressDelta(ProgressRules.xpOnScheduleCreate, ProgressRules.goldOnScheduleCreate);
      case RewardEvent.scheduleCompleted:
        return ProgressDelta(ProgressRules.xpOnScheduleComplete, ProgressRules.goldOnScheduleComplete);
    }
  }
}