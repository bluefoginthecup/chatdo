...
class ScheduleEntry {
  ...
  factory ScheduleEntry.fromJson(Map<String, dynamic> json) {
    ...
    final createdAt =
        parseDT(json['timestamp'] ?? json['createdAt'] ?? json['updatedAt']);
  ...
  factory ScheduleEntry.fromFirestore(
    ...
    final createdAt =
        parseDT(data['timestamp'] ?? data['createdAt'] ?? data['updatedAt']);
  ...
  /// 파서용 헬퍼
  static ScheduleEntry fromParsedEntry(
      DateTime date, ScheduleType type, String content) {
