    ...
    final image = (_resolvedUrl == null)
        ...
        : CachedNetworkImage(
            ...
            errorWidget: (_, __, ___) => Container(
              ...
              color: Colors.black12,
              alignment: Alignment.center,
              child: const Text('이미지 없음/경로 오류(404)',
                  style: TextStyle(fontSize: 12)),
            ),
          );
...
class ChatMessageCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rawImageUrls = (msg['imageUrls'] as List?)
        ...
        const <String>[];
    final imageUrls =
        rawImageUrls.map(_fixBucketOnce).where((e) => e.isNotEmpty).toList();

    final firstUrlRaw = (msg['imageUrl'] as String?) ??
    ...
    final String? timeText =
        createdAt != null ? formatKakaoTime(createdAt!) : null;
    ...
    if (isSystem) {
      final systemText =
          content.isNotEmpty ? content : ((msg['title'] as String?) ?? '알림');
