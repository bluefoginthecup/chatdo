...
class _ModeDateSelectorState extends State<ModeDateSelector>
  ...
  void _showOverlay() {
    ...
    final List<MapEntry<String, DateTime?>> options = [
      ...
      MapEntry(
          widget.selectedMode == Mode.todo ? '내일' : '어제',
                                  ...
                                  child: Wrap(
                                    ...
                                    children: List.generate(7, (i) {
                                      ...
                                      return ChoiceChip(
                                        ...
                                        visualDensity: VisualDensity.compact,
                                        label: Text(label),
                                        selected: widget.selectedDate.year ==
                                                target.year &&
    ...
    return Row(
      ...
      children: [
        OutlinedButton(
          onPressed: () {
            final newMode =
                widget.selectedMode == Mode.todo ? Mode.done : Mode.todo;
            widget.onModeChanged?.call(newMode);
          },
          child: Text(
            widget.selectedMode == Mode.todo ? '할일' : '한일',
            style: TextStyle(
              color: widget.selectedMode == Mode.todo
                  ? Colors.teal
                  : Colors.orange,
            ),
          ),
