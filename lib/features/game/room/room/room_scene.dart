...
import 'package:chatdo/features/game/room/day_event.dart';
import 'package:chatdo/features/game/room/girl_sprite.dart';
import 'package:chatdo/features/game/room/jordy_sprite.dart';
import 'package:chatdo/shared/providers/audio_manager.dart';
import '/game/components/speech_bubble_component.dart';
import 'package:chatdo/features/game/core/weather_scene_controller.dart';
import 'package:chatdo/shared/services/weather_service.dart';
import 'package:chatdo/features/game/room/dialogue_helper.dart';
...
class RoomScene extends Component with HasGameRef<FlameGame> {
  ...
  Future<void> onLoad() async {
    ...
    if (isMorningWeatherTime) {
      ...
      final indoorBgPath =
          await weatherController.getIndoorBackground(weatherDescription);
