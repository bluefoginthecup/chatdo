...
import 'package:chatdo/features/game/components/speech_bubble_component.dart';
...
import 'package:chatdo/shared/data/models/weather_data.dart';
...
class WeatherSceneController {
  ...
  Future<List<String>> getWeatherDialogues() async {
    final rawData =
        await _repository.getCachedOrFetchWeather(); // ✅ 캐시된 데이터 재활용
    ...
    final jsonStr =
        await rootBundle.loadString('assets/data/weather_dialogues.json');
