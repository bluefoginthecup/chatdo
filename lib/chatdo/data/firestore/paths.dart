...
abstract class UserStorePaths {
  ...
  CollectionReference<Map<String, dynamic>> customTags(
      String uid); // ← 컬렉션(문서=태그)
...
class FirestorePathsV1 implements UserStorePaths {
  ...
  @override
  DocumentReference<Map<String, dynamic>> textDictionary(String uid) => db
      .collection('users')
      .doc(uid)
      .collection('text_dictionary')
      .doc('default');
}
