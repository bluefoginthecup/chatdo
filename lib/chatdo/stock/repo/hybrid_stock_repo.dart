...
class HybridStockRepo implements StockRepo {
  ...
  @override
  Future<void> createSub(String folder, String sub) => local.createSub(folder, sub);
  @override
  Future<void> deleteSub(String folder, String sub) => local.deleteSub(folder, sub);

  @override
  Stream<List<StockItem>> watchItems(String folder, String sub) => local.watchItems(folder, sub);
  @override
  Future<void> addItem(StockItem item) => local.addItem(item);
  @override
  Future<void> updateItem(StockItem item) => local.updateItem(item);
  @override
  Future<void> deleteItem(String folder, String sub, String id) => local.deleteItem(folder, sub, id);
}
